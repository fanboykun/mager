    ...
    <div class="grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="col-span-12 xl:col-span-4 xxl:col-span-3">
          <div class="box p-5 intro-y">
            <button type="button" wire:click="$emit('openModal','schedule.add-schedule')" class="btn btn-primary w-full mt-2">
              <i class="w-4 h-4 mr-2" data-feather="edit-3"></i> Add New
              Schedule
            </button>
            <div
              class="
            ...
            <div class="relative">
              ...
              >
                ...
                <div class="pr-10">
                  <div class="event__title truncate">{{ Str::limit($schedule->title, 20, '...') }}</div>
                  <div class="text-gray-600 text-xs mt-0.5">
                    <span class="event__days">{{ $schedule->created_at }}</span> Days
          ...
          {{-- <div class="box p-5 intro-y mt-5">
            ...
            <div
              class="border-t border-gray-200 dark:border-dark-5 pt-5 mt-5"
            >
