        ...
        <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
            <div class="flex items-center border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                ...
                <div class="ml-3 mr-auto">
                    <a href="" class="font-medium">{{ $division->manager->name }}</a>
                    <div class="flex text-gray-600 truncate text-xs mt-0.5">
                        <a class="text-theme-1 dark:text-theme-10 inline-block truncate" href="">Sport &amp; Outdoor</a>
                ...
                <div class="dropdown ml-3">
                    ...
                    <div class="dropdown-menu w-40">
                        <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 w-4 h-4 mr-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg> Edit Post
                            </a>
                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash w-4 h-4 mr-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Delete Post
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-2">
                <a href="" class="block font-medium text-base mt-5">{{ $division->name }}</a>
                <div class="text-gray-700 dark:text-gray-600 mt-2">{{ $division->description }} </div>
            </div>
            <div class="flex items-center px-5 py-3 border-t border-gray-200 dark:border-dark-5">
                ...
                <div class="intro-x flex mr-2">
                    ...
                    <div class="intro-x w-8 h-8 image-fit {{ $loop->iteration != 1 ? '-ml-4' : '' }}">
                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="{{ $member->profile_photo_url }}">
                    </div>
                    @endforeach
                </div>
            ...
            <div class="px-5 pt-3 pb-5 border-t border-gray-200 dark:border-dark-5">
                <div class="w-full flex text-gray-600 text-xs sm:text-sm">
                    ...
                    <div class="ml-auto">
                        Announcemnts: <span class="font-medium">{{ $division->announcements_count }}</span>
                    </div>
                </div>
            </div>
        </div>
