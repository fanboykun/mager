    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y blog col-span-12 md:col-span-6 box">
            <div class="blog__preview image-fit">
              ...
              <div class="absolute w-full flex items-center px-5 pt-6 z-10">
                ...
                <div class="ml-3 text-white mr-auto">
                  <a href="" class="font-medium">{{ $article->user->name }}</a>
                  <div class="text-xs mt-0.5">{{ $article->created_at->diffForHumans() }}</div>
                </div>
            ...
            <div class="p-5 text-gray-700 dark:text-gray-600">
              {!! Str::limit($article->paragraph, 100, '...') !!}
            </div>
            <div
              class="
                flex
            ...
            >
              <a
                ...
                class="
                  ...
                  dark:border-dark-5 dark:bg-dark-5 dark:text-gray-300
                  text-gray-600
                  mr-2
                  tooltip
                "
              ...
              <div class="intro-x flex mr-2">
                ...
                <div class="intro-x w-8 h-8 image-fit -ml-4">
                  <img
                    alt="Rubick Tailwind HTML Admin Template"
                    class="rounded-full border border-white zoom-in tooltip"
                    src="http://rubick-laravel.left4code.com/dist/images/profile-8.jpg"
            ...
            <div
              class="px-5 pt-3 pb-5 border-t border-gray-200 dark:border-dark-5"
            >
              <div class="w-full flex text-gray-600 text-xs sm:text-sm">
                <div class="mr-2">
                  Comments: <span class="font-medium">93</span>
                </div>
                <div class="mr-2">
                  Views: <span class="font-medium">88k</span>
                </div>
                <div class="ml-auto">
                  Likes: <span class="font-medium">50k</span>
                </div>
              </div>
        ...
        class="
            ...
            items-center">
        <button class="btn btn-primary shadow-md mr-2" role="button" wire:click="loadMore">Load More</button>
        </div>
        <!-- END: Pagiantion -->
    </div>
<!-- END: Blog Layout -->
