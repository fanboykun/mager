<div>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Your Division Timeline</h2>
      </div>
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
            ...
            <div class="report-timeline mt-5 relative">
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Rubick Tailwind HTML Admin Template" src="http://rubrick.test/dist/images/profile-6.jpg">
                        </div>
                    </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Rubick Tailwind HTML Admin Template" src="http://rubrick.test/dist/images/profile-13.jpg">
                        </div>
                    </div>
                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        <div class="flex items-center">
                        ...
                        <div class="text-gray-600">
                            ...
                            <div class="flex mt-2">
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in">
                                    <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="http://rubrick.test/dist/images/preview-6.jpg">
                                </div>
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in">
                                    <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="http://rubrick.test/dist/images/preview-7.jpg">
                                </div>
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in">
                                    <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="http://rubrick.test/dist/images/preview-2.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Rubick Tailwind HTML Admin Template" src="http://rubrick.test/dist/images/profile-15.jpg">
                        </div>
                    </div>
                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        <div class="flex items-center">
                        ...
                        <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark:text-theme-10" href="">Nike Air Max 270</a> price and description</div>
                    </div>
                </div>
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            {{-- <div class="intro-y box col-span-12 xxl:col-span-6">
              ...
              >
                ...
                <button class="btn btn-outline-secondary hidden sm:flex">
                  <i data-feather="file" class="w-4 h-4 mr-2"></i> Download
                  Excel
                </button>
              </div>
              <div class="p-5">
                <div class="relative flex items-center">
                  <div class="w-12 h-12 flex-none image-fit">
                    <img
                      ...
                      class="rounded-full"
                      src="http://rubick-laravel.left4code.com/dist/images/profile-3.jpg"
                    />
                  </div>
                  ...
                  <div class="dropdown-menu w-40">
                    ...
                    >
                      <a
                        ...
                        "
                      >
                        <i data-feather="edit-2" class="w-4 h-4 mr-2"></i> New
                        Chat
                      </a>
                      <a
                        href=""
              ...
              <div class="p-5">
                ...
                >
                  ...
                  >
                    <i
                      data-feather="box"
                      class="block w-6 h-6 mb-2 mx-auto"
                    ></i>
                    Laravel
                  </a>
                  <a
                ...
                <div class="tab-content mt-8">
                  ...
                  >
                    <div class="flex flex-col sm:flex-row items-center">
                      ...
                      >
                        <div
                          class="bg-theme-18 text-theme-9 rounded px-2 mr-5"
                        >
                          +20%
                        </div>
            ...
            <div class="intro-y box col-span-12 xxl:col-span-6">
              ...
              >
                ...
                <div
                  class="nav nav-tabs ml-auto hidden sm:flex"
                  role="tablist"
                >
                  <a
                    data-toggle="tab"
              ...
              <div class="p-5">
                <div class="tab-content">
                  ...
                  >
                    ...
                    <a
                      href=""
                      class="btn btn-secondary block w-40 mx-auto mt-5"
                      >View More Details</a
                    >
                  </div>
                </div>
