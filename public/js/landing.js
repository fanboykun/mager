!(function () {
    "use strict";
    const e = document.getElementsByClassName("tg");
    function t(e, t) {
        e.classList.add("tb"), (t.style.maxHeight = t.scrollHeight + "px");
    }
    function n(e, t) {
        e.classList.remove("tb"), (t.style.maxHeight = null);
    }
    if (e.length > 0)
        for (let i = 0; i < e.length; i++) {
            ...
            a.classList.contains("tb") && t(a, l),
                s.addEventListener("click", function () {
                    a.classList.contains("tb") ? n(a, l) : t(a, l);
                });
        }
})(),
    (function () {
            ...
            for (let a = 0; a < t.length; a++) {
                ...
                for (let e = 0; e < u.length; e++) {
                    ...
                    t.addEventListener("click", function (e) {
                        if ((e.preventDefault(), t.classList.contains("tb")))
                            return;
                        for (let e = 0; e < u.length; e++)
                            u[e].classList.remove("tb");
                        for (let e = 0; e < c.length; e++)
                            c[e].classList.remove("tb");
                        let n = this.getAttribute("data-bullet");
                        c[n].classList.add("tb"),
    ...
    // (function () {
    //     "use strict";
    //     const e = document.getElementsByClassName("tx"),
    //         t = document.getElementsByClassName("modal-trigger");
    //     function n() {
    //         document.body.classList.remove("modal-is-active");
    //         for (let t = 0; t < e.length; t++) e[t].classList.remove("tb");
    //     }
    ...
    //         (e.target.classList.contains("tx") ||
    ...
    // (function () {
    //     "use strict";
    //     const e = document.querySelectorAll(".ie");
    //     if (e.length > 0)
    ...
    //                 (s.thumbSize = parseInt(
    //                     window
    //                         .getComputedStyle(s.currentValEl)
    ...
    //                 const t = a[e],
    //                     n = {};
    //                 (n.currency = t.parentNode.querySelector(".iw")),
    //                     (n.amount = t.parentNode.querySelector(
    //                         ".pricing-item-price-amount"
    //                     )),
    //                     (n.after = t.parentNode.querySelector(
    //                         ".pricing-item-price-after"
    //                     )),
    //                     (n.data = JSON.parse(
    //                         t.getAttribute("data-price-output")
    //                     )),
    //                     l.push(n);
    //             }
    ...
    (function () {
        ...
        function i() {
            ...
            !(function () {
                if (
                    e.length >
                    document.querySelectorAll("[class*=reveal-].is-revealed")
                        .length
                )
                    return;
    ...
    // (function () {
    //     "use strict";
    //     const e = document.getElementsByClassName("nr");
    //     function t(e) {
    //         let t = e.getAttribute("aria-controls");
    //         document.getElementById(t).classList.add("tb"),
    //             e.classList.add("tb");
    //     }
    //     if (e.length > 0)
    //         for (let n = 0; n < e.length; n++) {
    ...
    //                 n.preventDefault();
    //                 const i =
    //                     this.closest(".tabs").getElementsByClassName("ni");
    //                 if (!this.classList.contains("tb")) {
    //                     for (let t = 0; t < e.length; t++)
    //                         e[t].classList.remove("tb");
    //                     for (let e = 0; e < i.length; e++)
    //                         i[e].classList.remove("tb");
    //                     t(this);
    //                 }
    //             }),
    //                 i.classList.contains("tb") && t(i);
    //         }
    // })()
    // ;
